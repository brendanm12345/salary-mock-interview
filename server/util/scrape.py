...
def parse_doc(url: [str], filename: Optional[str] = None):
    plaintext = ""
    if url:
...
if __name__ == '__main__':
    ...
    result = parse_doc("https://s3.amazonaws.com/nicbor.com/sample_job_description.html")

    print("Test HTML parser from URL")
    result = parse_doc("https://s3.amazonaws.com/nicbor.com/sample_resume.html")
    print(result)
